...
namespace RagePixel2
{
	public class RagePixelEditorWindow : EditorWindow
	{
		...
		{
			m_PaintColor = Utility.PaintColorField (m_PaintColor, k_SceneButtonSize, k_SceneButtonSize);
			BasicModeButton (SceneMode.ReplaceColor, Resources.arrowRight);
			if (mode == SceneMode.ReplaceColor)
			{
				replaceTargetColor = Utility.PaintColorField (replaceTargetColor, k_SceneButtonSize, k_SceneButtonSize);
		...
		{
			BasicModeButton (SceneMode.Default, Resources.arrow);
		}

		public void PencilOnGUI ()
		{
			BasicModeButton (SceneMode.Paint, Resources.pencil);
		}

		public void FloodFillOnGUI ()
		{
			BasicModeButton (SceneMode.FloodFill, Resources.floodfill);
		}
		...
		private void BasicModeButton (SceneMode buttonMode, Texture2D icon)
		{
			...
			GUILayout.Toggle (mode == buttonMode, icon, GUI.skin.button, GUILayout.Width (k_SceneButtonSize),
				GUILayout.Height (k_SceneButtonSize));
